...
model = load_model('output_files/models/bpi_12_w/model_03-1.72.h5')
...
# make predictions
with open('output_files/results/bpi_12/suffix_and_remaining_time_permitw%s' % eventlog, 'wb') as csvfile:
