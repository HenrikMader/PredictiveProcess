...
for i, sentence in enumerate(sentences):
    ...
    # I commented this out, since it threw an error otherwise
...
lr_reducer = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10, verbose=0, mode='auto', min_delta = 0.001, cooldown=0, min_lr=0)
